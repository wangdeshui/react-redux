...
import {fetchTodo, startRequestTodos, receiveTodos, todoAdded, todoRemoved, searchTodo, showAddTodoModal, hideAddTodoModal} from '../actions'

let todoList = (state = { isLoading: true }, action) => {
    switch (action.type) {
        case startRequestTodos.type:
